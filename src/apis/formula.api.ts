import { Formula, SalaryComponentCategory } from "@/data/schema/formula.schema";
...
const formulaApiRequest = {
    ...
    getAllSalaryComponents: () => http.get<ApiResponse<SalaryComponentCategory[]>>(`/fomulas/salary-components`),
}
