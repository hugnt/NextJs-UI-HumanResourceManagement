...
export default function SampleList() {
  ...
  const columnsDef: ColumnDef<Candidate>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="w-[100px]">{row.getValue("phone")}</div>
      ),
      enableSorting: false,
      enableHiding: false,
    },
    {
      ...
      cell: ({ row }) => (
        <div className="w-[250px]">{row.getValue("fileDataStore")}</div>
      ),
      enableSorting: false,
      enableHiding: false,
    },
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title="Bộ kiểm tra" />
      ),
      cell: ({ row }) => (
        <div className="w-[100px]">{row.getValue("testName")}</div>
      ),
      enableSorting: false,
      enableHiding: false,
    },
    {
      ...
      cell: ({ row }) => (
        <div className="w-[100px]">{row.getValue("interviewerName")}</div>
      ),
      enableSorting: false,
      enableHiding: false,
    },
    {
      ...
      cell: ({ row }) => <div>{getStatus(row.getValue("status"))}</div>,
      enableSorting: false,
      enableHiding: false,
    },
    {
  ...
  const handleView = async (row: Row<Candidate>) => {
    ...
    if (selectedData.fileDataStore) {
      const cvUrl =
        ...
        `${selectedData.fileDataStore.replace(/\\/g, "/")}`;
