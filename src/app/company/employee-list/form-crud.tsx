...
export default function FormCRUD(props: FormProps) {
  ...
  const form = useForm<Employee>({
    resolver: zodResolver(employeeDefault),
            ...
            <div>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-0">
                  <div className="grid grid-cols-3 gap-2 py-2 p-4">
                      ...
                      <FormField control={form.control} name="name"
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Nhập tên nhân viên" {...field} disabled={isDisabled} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <SelectOne onValueChange={field.onChange} value={field.value?.toString()} disabled={isDisabled} >
                              <FormControl >
                                <SelectTrigger >
                              ...
                              <SelectContent>
                                {
                                  listDataContact.data?.metadata?.map((x, i) => {
                                    return <SelectItem key={i} value={x.id?.toString() ?? "0"}>{"HD-00" + x.id}</SelectItem>
                                  })
                                }
                              </SelectContent>
                            </SelectOne>
                      ...
                      <FormField control={form.control} name="departmentName"
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Tên nhân viên</FormLabel>
                            <FormControl>
                              <Input placeholder="Tên phòng ban" {...field} disabled={true} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField control={form.control} name="positionName"
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Tên vị trí" {...field} disabled={true} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField control={form.control} name="phoneNumber"
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input type="tel" placeholder="Email" {...field} disabled={isDisabled} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField control={form.control} name="password"
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Mật khẩu" {...field} disabled={isDisabled} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                  ...
                  <div className="flex space-x-2 justify-start sticky bottom-0 p-4 py-2 bg-white border-t">
                    ...
                    {(mode === CRUD_MODE.ADD || mode === CRUD_MODE.EDIT) &&
                      <Button disabled={updateDataMutation.isPending} type="submit" size='sm' className='h-8 bg-primary'>
