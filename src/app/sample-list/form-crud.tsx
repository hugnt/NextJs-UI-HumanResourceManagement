...
import { Person, personDefault, personSchema } from "@/data/schema/sample.schema";
                                ...
                                <FormField control={form.control} name="id"
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="Identity" {...field} disabled={isDisabled} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField control={form.control} name="age"
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input type="number" placeholder="0-100" {...field} disabled={isDisabled} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField control={form.control} name="address"
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="100 Distric, Forest, .." {...field} disabled={isDisabled} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
